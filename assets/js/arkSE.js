...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (window.location.hash) {
    // Find the tab with the corresponding id from the URL
    var tabId = window.location.hash; // e.g. '#server-rules-tab'
    var tabTrigger = document.querySelector(`a[href="${tabId}"]`);

    // Activate the tab and show its content
    if (tabTrigger) {
  ...
  // Listen for clicks on the links to change the URL hash and scroll
